		...
		<os:ElevationGridCoverage gml:id="os.t50.sd58.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd58.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd58.origin">
							<gml:pos>350000 480000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD58.asc</gml:fileReference><!-- URI -->
