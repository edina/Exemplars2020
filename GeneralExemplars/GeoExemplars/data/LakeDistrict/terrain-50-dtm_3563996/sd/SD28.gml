		...
		<os:ElevationGridCoverage gml:id="os.t50.sd28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd28.origin">
							<gml:pos>320000 480000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD28.asc</gml:fileReference><!-- URI -->
