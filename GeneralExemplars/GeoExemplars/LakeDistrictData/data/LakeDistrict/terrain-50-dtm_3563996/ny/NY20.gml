		...
		<os:ElevationGridCoverage gml:id="os.t50.ny20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny20.origin">
							<gml:pos>320000 500000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY20.asc</gml:fileReference><!-- URI -->
