...
<os:DataSet xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:os="http://namespaces.ordnancesurvey.co.uk/elevation/grid/v1.0" xmlns:gml="http://www.opengis.net/gml/3.2" gml:id="OSTerrain50.NY21.2019.Q2" xsi:schemaLocation="http://namespaces.ordnancesurvey.co.uk/elevation/grid/v1.0 http://www.ordnancesurvey.co.uk/xml/terrainschema/grid/v1/OSTerrainGridProducts.xsd">
	...
	<os:metadata xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="Metadata_NY21.xml"></os:metadata>
	<os:member>
		<os:ElevationGridCoverage gml:id="os.t50.ny21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny21.rectgrid">
					<gml:limits>
						<gml:GridEnvelope>
							<gml:low>0 0</gml:low>
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny21.origin">
							<gml:pos>320000 510000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY21.asc</gml:fileReference><!-- URI -->
